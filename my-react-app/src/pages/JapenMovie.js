...
export default function KoreaMovie() {
  ...
  const url = `https://kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieList.json?key=f5eef3421c602c6cb7ea224104795888&repNationCd=22041008&movieTypeCd=220101&openStartDt=2010&openEndDt=2022&itemPerPage=100`;
  const dispatch = useDispatch();
  useBoxOffice(dispatch, url, "japenMovieList");
